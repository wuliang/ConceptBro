...
#from orng.orngEnviron import directoryNames as old_directory_names
...
import utils
from utils import debugging as orngDebugging
from string import *
...
#            e.ignore()
    ...
    def getWidgetStateIcons(cls):
        if not hasattr(cls, "_cached__widget_state_icons"):
            iconsDir = os.path.join(environ.canvasDir, "icons")
            QDir.addSearchPath("canvasIcons",os.path.join(environ.canvasDir,
                "icons/"))
