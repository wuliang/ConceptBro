...
import orngDoc, orngOutput, orngRegistry, orngHelp
...
class WidgetListBase:
    ...
    def createWidgetTabs(self, widgetTabList, widgetRegistry, widgetDir, picsDir, defaultDir):
        ...
        for (tabName, show) in widgetTabList + extraTabs:
            #if not widgetRegistry: raise
            #QMessageBox.information(self, 'Orange Canvas', '%s' % str(widgetRegistry.keys()))
